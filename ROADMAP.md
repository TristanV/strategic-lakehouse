...
| **Qualité Great Expectations** | 🔴 À faire | — | Sprint 3 — **prochaine étape** |
...
- [ ] **Great Expectations — checkpoint Silver** ← prochaine étape
  - `src/quality/gx_checkpoint.py` : suite Silver sur `fact_sales` et `dim_products`
  - Expectations : `total_amount > 0`, `quantity ≥ 1`, `customer_id` non-null, unicité `product_id`
